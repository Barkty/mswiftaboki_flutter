    ...
    return TextField(
      ...
      decoration: InputDecoration(
        suffixIcon: InkWell(
          ...
          key: ispassword ? const Key('eye') : const Key('email'),
          onTap: () {
            if (ispassword) passwordVisible = !passwordVisible;
          },
          child: (ispassword && passwordVisible)
              ? const Icon(
                  Icons.visibility_off,
                  color: Colors.black,
                )
              : !ispassword ? const Icon(Icons.done) : const Icon(
                  Icons.visibility,
                  color: Colors.black,
                ),
        ),
